    ...
    <div class="row">
            <div class="col-sm-6 mx-auto">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php $products = query("SELECT * FROM products"); foreach($products as $prd):?>
                            <tr>
                                <td scope="row"><?=$prd['prd-nama'];?></td>
                                <td><?=$prd['prd-harga'];?></td>
                                <td><?=$prd['prd-kategori'];?></td> 
                                <td> <a href="update.php?id=<?=$prd['id'];?>" class="text-decoration-none">Edit</a> | <a href="delete.php?id=<?=$prd['id'];?>" class="text-decoration-none">Delete</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
